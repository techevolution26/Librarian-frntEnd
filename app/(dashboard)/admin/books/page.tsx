  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-white/55">
            Manage catalog metadata and PDF files.
          </p>
        </div>
      ...
      <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04]">
        <div className="hidden grid-cols-[80px_1fr_160px_120px_120px] border-b border-white/10 px-5 py-3 text-xs uppercase tracking-[0.16em] text-white/45 md:grid">
          <span>ID</span>
          <span>Title</span>
          <span>Author</span>
          <span>Source</span>
        ...
        <div className="divide-y divide-white/10">
          {books.map((book) => (
            <div
              key={book.id}
              className="grid gap-3 px-5 py-4 md:grid-cols-[80px_1fr_160px_120px_120px] md:items-center"
            >
              ...
              <p className="text-sm text-white/65">{book.source_type}</p>
